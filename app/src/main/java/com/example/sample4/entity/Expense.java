...
public class Expense {
   ...
   public Expense(double travelExpense, Bitmap travelImage, double fuelExpense, Bitmap fuelImage, double highwayChargeExpense, Bitmap highwayChargeImage, double parkingExpense, Bitmap parkingImage, double vehicleServiceExpense, Bitmap vehicleServiceImage, double nightOutExpense, Bitmap nightOutImage, double lunchExpense, Bitmap lunchImage, LocalDate expenseDate) {
   ...
   public Expense(String expenseID, double travelExpense, Bitmap travelImage, double fuelExpense, Bitmap fuelImage, double highwayChargeExpense, Bitmap highwayChargeImage, double parkingExpense, Bitmap parkingImage, double vehicleServiceExpense, Bitmap vehicleServiceImage, double nightOutExpense, Bitmap nightOutImage, double lunchExpense, Bitmap lunchImage, LocalDate expenseDate) {
